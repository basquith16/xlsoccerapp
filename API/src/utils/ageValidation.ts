 ...
 */
export const calculateAge = (birthDate: Date, currentDate: Date = new Date()): number => {
 ...
 */
export const isPlayerEligibleForAgeRange = (
  playerBirthDate: Date,
  sessionMinAge: number,
 ...
 * @returns True if player is eligible, false otherwise
 */
export const isPlayerEligibleForSession = (
  playerBirthDate: Date,
  session: { ageRange?: { minAge: number; maxAge: number }; birthYear?: number },
  currentDate: Date = new Date()
): boolean => {
 ...
 */
export const parseAgeRange = (ageRangeString: string): { minAge: number; maxAge: number } => {

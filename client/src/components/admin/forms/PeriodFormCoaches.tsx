...
interface PeriodFormCoachesProps {
  formData: {
    coachIds: string[];
  };
...
const PeriodFormCoaches: React.FC<PeriodFormCoachesProps> = ({
  formData,
  errors,
  onInputChange
}) => {
  ...
  return (
    <div>
      ...
      <p className="mt-2 text-sm text-gray-500">
        Select at least one coach or TBD for this period.
      </p>
    </div>
  );
};

export default PeriodFormCoaches; 